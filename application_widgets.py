...
class CommonListWidget(QtGui.QListWidget, WaitForSignalDialogMixin):
    ...
    def on_item_double_click_slot(self, double_clicked_item):
        ...
        hash_hex, prev = double_clicked_data["hash"], format(self.main.previous_hash.value, "x")  # turn long into hex
        ...
        self.main.set_clip_queue.put_nowait(dict(new_clip = double_clicked_data, block_clip_change_detection = False))
